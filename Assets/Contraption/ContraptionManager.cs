...
public class ContraptionManager : MonoBehaviour
{
    ...
    public void StartSimulation()
    {
        ...
        {
            NetworkId Last_Operator = (NetworkId)item.monoBehaviour.GetType().GetProperty("Last_Operator").GetValue(item.component);
            if (Last_Operator == me)
            {
